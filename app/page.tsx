    ...
    <>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .bs-nav{display:flex;justify-content:space-between;align-items:center;padding:20px 44px;border-bottom:1px solid #0F1E3A;}
        ...
        .bs-h1-ghost{font-family:'Playfair Display',serif;font-size:62px;font-style:italic;font-weight:400;color:#0D1E38;line-height:1.08;margin-bottom:32px;}
        ...
        .bs-url-bar{background:#050B18;border:1px solid #0F1E3A;border-radius:6px;padding:7px 14px;font-size:13px;color:#1E3050;margin-bottom:18px;font-style:italic;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;}
        ...
        .bs-step{background:#070F22;border:1px solid #0F2040;border-radius:16px;padding:28px 24px;}
        ...
        .bs-final{background:#070F22;border-top:1px solid #0F1E3A;padding:80px 44px;text-align:center;}
