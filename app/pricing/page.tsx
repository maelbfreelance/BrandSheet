    ...
    <>
      ...
      <div className="body">
        ...
        <p className="legend">
          ...
          ✦ <strong>Analyse de marque</strong> : 1ère analyse <strong>offerte à vie</strong> à l'inscription, puis <strong>5 crédits par analyse</strong> sur tous les plans. L'analyse gratuite est <strong>unique à vie</strong> — souscrire à un abonnement après l'avoir consommée ne la réinitialise pas.<br />
